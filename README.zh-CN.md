...
- **终端仪表盘（TUI）**: 当前提供 dependency-free 的状态面板与 prompt 控制台；更丰富的多会话 TUI 范围请以 `docs/architecture-deep-dive.zh-CN.md` 为准。
...
然后在浏览器打开 `http://127.0.0.1:3000/inspect`。

完整命令清单、示例和 HTTP endpoint 说明请查看 [docs/QUICKSTART.md](./docs/QUICKSTART.md) 与 [docs/QUICKSTART.zh-CN.md](./docs/QUICKSTART.zh-CN.md)。
